...
1. Fork [this repository](https://github.com/dadaloser/chatGPTx) and create a branch from `main`. For new feature implementations, submit a pull request to the `feature` branch. For other changes, submit to the `main` branch.
